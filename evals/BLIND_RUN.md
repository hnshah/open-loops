...
6. Re-run the hard smoke after behavior changes.
7. Run all 64 baseline cases.
8. Run all 64 skill cases with the same model and settings.
9. Preserve the raw output files generated by the harness.
10. Freeze both prediction files before looking at gold or scores.
11. Score baseline and skill.
12. Manually inspect every disagreement that matters.
